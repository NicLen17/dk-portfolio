...
export function Footer() {
  ...
  return (
    <footer className="bg-black border-t border-white/10">
      <div className="max-w-[1600px] mx-auto px-6 md:px-10 lg:px-16 py-12 md:py-16">
            ...
            <div className="flex flex-col gap-3">
              {socialLinks.map((link) => (
                <a
                  ...
                  className="flex items-center gap-3 text-sm font-body text-neutral-400 hover:text-white transition-colors duration-200"
                >
